              ...
              {restaurant.google_rating != null && restaurant.google_rating > 0 ? (
                <span className="flex items-center gap-1 text-sm font-semibold text-[#1C1F1A]">
                  ...
                  {restaurant.google_review_count != null && restaurant.google_review_count > 0 && (
                    <span className="text-[#6D9450] text-xs font-normal">({restaurant.google_review_count})</span>
                  )}
                </span>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-2xl p-4 border border-[#EEF5E6]">
              ...
              {restaurant.opening_hours_note && (
                <p className="mt-3 pt-3 border-t border-[#EEF5E6] text-xs text-[#6D9450] leading-relaxed">
                  {restaurant.opening_hours_note}
                </p>
              )}
            </div>
